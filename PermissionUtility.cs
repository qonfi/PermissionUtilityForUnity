...
namespace AndroidUtility
{
    public class PermissionUtility 
    {
        ...
        public static void Request(PermissionKey permission)
        {
            ...
            string className = Permission.UtilityClassName;
            string methodName = Permission.RequestMethodName;
            string permissionName = Permission.Permissions[permission];
        ...
        public static bool IsPermitted(PermissionKey permission)
        {
            ...
            string className = Permission.UtilityClassName;
            string methodName = Permission.IsPermittedMethodName;
            string permissionName = Permission.Permissions[permission];
